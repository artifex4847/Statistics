...
Data TS0.example01_nhmonth;
         infile 'C:\Data_cru\NH_month.dat';
         input temperature @@;
		 ...
		 t=_N_;
run;
Data TS0.example01_n;
set TS0.example01_nhmonth;
if _N_<121 then delete;
run;
Proc gplot data= TS0.example01_n; 
      symbol i=joint v= h=1; 
      plot temperature * date;
      title 'North monthly temperature from 1900 to 2012';
   run;

Proc glm data=TS0.example01_n; 
class month; 
