...
Data TS9.example91_sgl;
infile 'C:\Data_cru\SH_year.dat';
input temperatureV @@;
...
Data TS9.example91_sgl1;
set TS9.example91_sgl;
if t>1900 then output;
run;

Data aa;
set TS9.example91_sgl1;
y=temperatureV+0.55;
run;
...
proc arima data=TS9.example91_sgl1;
...
title 'North temperature from 1901 to 2022';
run;
...
data bb; merge TS9.example91_sgl1 b; by t; run;

proc print data=bb;
run;

proc autoreg data=bb;
 model temperatureV=t/nlag=48 dwprob dw=8 backstep method=ml;
...
axis1 label=(a=90 'North yearly temperature data from 1850 to 2011');
...
title 'North yearly temperature from 1900 to 2022';
